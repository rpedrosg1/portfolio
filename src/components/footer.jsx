      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              Backend Software Engineer building scalable systems and cloud infrastructure in Porto, Portugal.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <a href="mailto:rpedrosg1@hotmail.com" className="transition-colors hover:text-primary">
                  rpedrosg1@hotmail.com
                </a>
              </li>
        ...
        <div className="mt-12 flex items-center justify-center border-t border-border pt-8">
          <p className="text-xs text-muted-foreground">
            {"\u00a9"} {new Date().getFullYear()} Rui {"Gon\u00e7alves"}. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
